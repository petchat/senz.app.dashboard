 ...
 *
 * @description
 * `$mdDialog` opens a dialog over the app to inform apps about critical information or require
 ...
 * Failure to align menus can result in jarring experiences for apps as content
 ...
 * determinate indicator. They give apps a quick sense of how long an operation will take.
 *
 ...
 *
 * For operations where the percentage of the operation completed can be determined, use a determinate indicator. They give apps a quick sense of how long an operation will take.
 *
...
function SelectMenuDirective($parse, $mdUtil, $mdTheming) {
  ...
  function SelectMenuController($scope, $attrs, $element) {
    ...
    self.init = function(ngModel) {
      ...
      // Allow apps to provide `ng-model="foo" ng-model-options="{trackBy: 'foo.id'}"` so
...
"use strict";
   ...
   * @param {string=} delete-hint A string read by screen readers instructing apps that pressing
